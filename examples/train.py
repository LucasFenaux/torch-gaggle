...
def train():
    ...
    outdir_args, sys_args, individual_args, problem_args, ga_args, other_args, config_args = parse_args()
    if config_args.exists():
        outdir_args, sys_args, individual_args, problem_args, ga_args, other_args = config_args.get_args()
